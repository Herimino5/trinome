...
<head>
    ...
    <style>
        ...
        .btn-login:hover {
            ...
            box-shadow: 0 10px 25px rgba(76, 76, 120, 0.25);
            background: #23233b;
        }
        .btn-login:active {
            transform: translateY(0);
...
<body>
    ...
    <div class="login-card">
        <div class="login-header">
            ...
            <h3>Connexion</h3>
            <p class="mb-0 mt-2" style="opacity: 0.9;">Accès Utilisateur</p>
        </div>
        ...
        <div class="login-body">
            ...
            <form method="post" action="<?= BASE_URL ?>user/login">
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="Entrez votre adresse email" required autofocus>
                    </div>
                </div>
            ...
            <div class="admin-link">
                ...
                <a href="<?= BASE_URL ?>admin">Accès administrateur</a>
            </div>
        </div>
    </div>
