...
$app->set('flight.base_url', '/trinome/my-project/public');           // Base URL for your app. Change if app is in a subdirectory (e.g., '/myapp/')
define('BASE_URL', '/trinome/my-project/public/');                     // Constant for use in views (with trailing slash)
...
return [
	...
	'database' => [
		...
		'dbname'   => 'trinome_prepas',   // Database name (e.g., 'flightphp')
